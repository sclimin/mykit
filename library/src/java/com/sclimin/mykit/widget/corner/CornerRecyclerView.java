 ...
 * 创建时间：2018/08/10
 */
public class CornerRecyclerView extends RecyclerView implements CornerView {

    private final CornerDelegate mDelegate;

    public CornerRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CornerRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
