 ...
 * 创建时间：2018/08/10
 */
public class CornerImageButton extends AppCompatImageButton implements CornerView {

    private final CornerDelegate mDelegate;

    public CornerImageButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CornerImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
