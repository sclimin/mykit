 ...
 * 创建时间：2018/08/10
 */
public class CornerConstraintLayout extends ConstraintLayout implements CornerView {
    ...
    public CornerConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
